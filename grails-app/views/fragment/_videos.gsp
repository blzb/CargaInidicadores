                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/comisiones', file: 'demo.html')}');">Ver</a>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/comisiones', file: 'tutorial.html')}');">Ver</a>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/comisiones', file: 'practice.html')}');">Ver</a>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/comisiones', file: 'test.html')}');">Ver</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h4>Demostracion</h4>
                                    <p class="">Puedes observar la demostracion sin interactuar</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/procuraduria', file: 'demo.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'tutorial.png')}"/></td>
                                <td>
                                    <h4>Tutorial</h4>
                                    <p class="">Interactua con la demostracion siguiendo las indicaciones</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/procuraduria', file: 'tutorial.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'practice.png')}"/></td>
                                <td>
                                    <h4>Practica</h4>
                                    <p class="">Interactua con la presentacion por tu cuenta con avisos en caso de error</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/procuraduria', file: 'practice.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'test.png')}"/></td>
                                <td>
                                    <h4>Examen</h4>
                                    <p class="">Interactua con la presentacion sin indicaciones y obten una calificacion al final</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/procuraduria', file: 'test.html')}');">Ver</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h4>Demostracion</h4>
                                    <p class="">Puedes observar la demostracion sin interactuar</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/defensoria', file: 'demo.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'tutorial.png')}"/></td>
                                <td>
                                    <h4>Tutorial</h4>
                                    <p class="">Interactua con la demostracion siguiendo las indicaciones</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/defensoria', file: 'tutorial.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'practice.png')}"/></td>
                                <td>
                                    <h4>Practica</h4>
                                    <p class="">Interactua con la presentacion por tu cuenta con avisos en caso de error</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/defensoria', file: 'practice.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'test.png')}"/></td>
                                <td>
                                    <h4>Examen</h4>
                                    <p class="">Interactua con la presentacion sin indicaciones y obten una calificacion al final</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/defensoria', file: 'test.html')}');">Ver</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h4>Demostracion</h4>
                                    <p class="">Puedes observar la demostracion sin interactuar</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/tribunales', file: 'demo.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'tutorial.png')}"/></td>
                                <td>
                                    <h4>Tutorial</h4>
                                    <p class="">Interactua con la demostracion siguiendo las indicaciones</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/tribunales', file: 'tutorial.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'practice.png')}"/></td>
                                <td>
                                    <h4>Practica</h4>
                                    <p class="">Interactua con la presentacion por tu cuenta con avisos en caso de error</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/tribunales', file: 'practice.html')}');">Ver</a>
                                </td>
                                <td class="small" style="vertical-align: top; padding-right:10px;"><img src = "${resource(dir: 'images', file: 'test.png')}"/></td>
                                <td>
                                    <h4>Examen</h4>
                                    <p class="">Interactua con la presentacion sin indicaciones y obten una calificacion al final</p>
                                    <a class="btn btn-default" href="" onclick = "window.open('${resource(dir: 'presenter/tribunales', file: 'test.html')}');">Ver</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
